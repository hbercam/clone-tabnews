        ...
        test("With new 'password'", async () => {
            const user1Response = await fetch(
                "http://localhost:3000/api/v1/users",
                {
                    ...
                    body: JSON.stringify({
                        ...
                        email: "uniqueEmail1@kolabia.com",
                        password: "senha123",
                    }),
                },
            );
            ...
            const response = await fetch(
                "http://localhost:3000/api/v1/users/uniqueEmail1",
                {
                    ...
                    body: JSON.stringify({
                        email: "uniqueEmail2@kolabia.com",
                    }),
                },
            );
            ...
            const user1Response = await fetch(
                "http://localhost:3000/api/v1/users",
                {
                    ...
                    body: JSON.stringify({
                        ...
                        email: "newPassword1@kolabia.com",
